<template>
  <div class="calculator">
    ...
    <div class="houseAfordibility">
      ...
      <h4>How much of a downpayment have you saved up?</h4>
      <input name="Money" type="text" placeholder="Don't be shy! 200? 400? 1000? " v-model="downpayment" />

      <h4>How much do you currently spend on rent?</h4>
      <input name="Money" type="text" placeholder="Include parking and stuff like that" v-model="rent" />

      <h4>How much do you make a after tax in a year?</h4>
...
<script>
 ...
 export default{
     computed: {
         ...
         showResults(){
             ...
             if(!this.selectedCity || !this.downpayment || !this.income || income < 10000){ return false}
             const loan = parseFloat(this.loanSize)


             let confidenceScore = Math.floor(income/loan*5)
             if(confidenceScore > 4){confidenceScore = 4}

             return {
                 confidenceImage: confidenceImages[confidenceScore],
                 confidenceText: confidenceTexts[confidenceScore],
 ...
 const confidenceTexts = [
     "WTF is wrong with you, you can't afford a house",
     "ehhhhh, you may be able to make it work, but I wouldn't push it",
     "hmmm, yea, maybe you could swing owning a house",
     "you got this dude, buy that house!",
     "Okay richy rich, calm down"

 ]

 const confidenceImages = [
     "https://media.giphy.com/media/Ojr9vupbS0v0GWDgxm/giphy.gif", /* donald glover running */
     "https://media3.giphy.com/media/12q9pxwZrKDZHq/source.gif", /* jonas hill neck naa*/
     "https://media2.giphy.com/media/DfdbTJZx6Yjra/source.gif", /* wolf of walstree maybe*/
     "https://media2.giphy.com/media/XreQmk7ETCak0/source.gif", /* great job thumbs up */
     "http://giphygifs.s3.amazonaws.com/media/94EQmVHkveNck/giphy.gif" /* woddy harrelson crying into money */
 ]


 /* todo, break this out into its own thing I import into other layouts */
 const states  = [
